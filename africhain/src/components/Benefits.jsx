...
export default function Benefits(){
  const heroContents = [
         {
             image: <CiLock className='w-[40px] h-[40px] text-[#1d513b]'/>,
         ...
         {
             image: <IoBagCheckSharp className='w-[40px] h-[40px] text-[#1d513b]'/>,
             headerText: 'Avoid grey markets',
             story: 'Detect grey market suppliers with our reliable, practicable security tags.'
         },
         {
             image: <PiAirTrafficControlFill className='w-[40px] h-[40px] text-[#1d513b]'/>,
         ...
         {
             image: <BsStars className='w-[40px] h-[40px] text-[#1d513b]'/>,
         ...
         {
             image: <TbCapture className='w-[40px] h-[40px] text-[#1d513b]'/>,
        ...
        {
          image: <GiBreakingChain className='w-[40px] h-[40px] text-[#1d513b]'/>,
          headerText: 'Provide Transparency',
          story: 'Leveraging the blcokchain immutability.'
       },
     ]
             ...
             <section className='flex flex-wrap items-center justify-around md:px-3 gap-3'>
                 { 
                     heroContents.map((data,index) => (
                         <div key={index}
                             className='flex flex-col justify-center items-center gap-2 w-[250px] md:w-[350px] h-[220px] border-[1px] rounded transform duration-[300] transition hover:shadow-lg'>
                             {data.image}
                             <article className='flex flex-col w-full justify-center items-center text-center'>
                                 <h6 className='text-[1.1rem] font-bold text-[#143d2d]'>{data.headerText}</h6>
                                 <p className='hidden md:flex text-center text-[0.9rem] font-[400] px-4'>{data.story}</p>
                             </article>
                         </div>
                     ))
                 }
